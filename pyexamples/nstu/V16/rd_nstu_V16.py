...
bbb.pcoree = 1.0e6
bbb.pcorei = 1.0e6
bbb.isnicore[0] = 1     # switch for ion-density core BC
bbb.ncore = 1.55e19      # is isnicore = 1, set core ni BC.
...
bbb.igaso[2] = 57000.         # amps (as if neutral has charge e)
...
bbb.difni[0] = .74	#D for radial hydrogen diffusion
bbb.kye = 14.		#chi_e for radial elec energy diffusion
bbb.kyi =16.    	#chi_i for radial ion energy diffusion
